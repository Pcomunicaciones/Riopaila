  ...
  <div className="animate-in fade-in duration-700 pb-20" style={{ fontFamily: 'Tahoma, sans-serif' }}>
    ...
    <DataCard title="Junta Directiva 2026 - 2027">
      ...
      <div className="grid md:grid-cols-2 gap-x-12 gap-y-6">
        {[
          { p: "MARIA ALEJANDRA CABAL GONZÁLEZ", s: "FELIPE ARÉVALO BOTERO" },
          ...
          { p: "MAURICIO BOTERO CAICEDO", s: "ADRIANA BOTERO BARCO" },
          { p: "SEBASTIÁN HOLMANN GONZÁLEZ", s: "FEDERICO JOSÉ HOLMANN SAÉNZ" }
        ].map((item, i) => (
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="text-sm font-bold text-red-800 space-y-2 mb-4">
              ...
              <p>Sebastián Holmann González</p>
              <p>Rafael González Ulloa</p>
            </div>
          ...
          <div>
            <p className="text-[10px] font-black text-red-600 uppercase mb-3 tracking-widest">Sostenibilidad y Riesgos</p>
            <div className="space-y-3 mb-4">
              <div className="border-l-2 border-gray-100 pl-3">
                ...
                <p className="text-[11px] text-gray-500 font-medium">Principal</p>
              </div>
              <div className="border-l-2 border-gray-100 pl-3">
                <p className="text-sm font-bold text-red-800">Mauricio Botero Caicedo</p>
                <p className="text-[11px] text-gray-500 font-medium">Principal</p>
              </div>
              <div className="border-l-2 border-gray-100 pl-3">
                <p className="text-sm font-bold text-red-800">Rafael González Ulloa</p>
                <p className="text-[11px] text-gray-500 font-medium">Principal</p>
              </div>
            </div>
...
const InfoRelevanteView = () => {
  const hechos = [
    //(SEPTIEMBRE)
    {
      ...
      doc: "Riop Inf Periodico II Trimestre 2026.pdf"
    },
    //15-05-2026
    {
      f: "15/05/2026",
